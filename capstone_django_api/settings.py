"""
Django settings for capstone_django_api project.
...
if os.getenv('ENV') == 'development':
  ...
  CORS_ORIGIN_WHITELIST = ['http://localhost:7165', 'https://guyfredw.github.io']
else:
...
ROOT_URLCONF = 'capstone_django_api.urls'
...
WSGI_APPLICATION = 'capstone_django_api.wsgi.application'
