...
from .views.post_unauthenticated_views import APosts, UnauthenticatedPostDetail
...
urlpatterns = [
    ...
    path('show-post/<int:pk>', UnauthenticatedPostDetail.as_view(), name='upost_detail')
]
