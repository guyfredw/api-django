...
This template contains a project, `capstone_django_api`, and an app, `api`,
...
1. Replace all instances of `capstone_django_api` with your application name. **This includes the folder included in this repository.**
...
This template includes a project `capstone_django_api` which should be renamed
...
all instances of `capstone_django_api` with your app's name.
